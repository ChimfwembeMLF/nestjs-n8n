...
\`\`\`bash
npm install @your-org/nestjs-n8n
# or
yarn add @your-org/nestjs-n8n
# or
pnpm add @your-org/nestjs-n8n
\`\`\`
...
import { N8nModule } from '@your-org/nestjs-n8n';
...
import { N8nClientService } from '@your-org/nestjs-n8n';
...
import { N8nWebhook, WebhookService } from '@your-org/nestjs-n8n';
...
import { N8nWebhook, WebhookValidationGuard } from '@your-org/nestjs-n8n';
...
\`\`\`typescript
import { CreateWorkflowDto, UpdateWorkflowDto } from '@your-org/nestjs-n8n';
...
import { N8nModule, N8nClientService } from '@your-org/nestjs-n8n';
